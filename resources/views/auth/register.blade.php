                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="registeredDate" class="col-md-4 col-form-label text-md-right">{{ __('Registered Date') }}</label>

                            <div class="col-md-6">
                                <input id="registeredDate" type="date" class="form-control{{ $errors->has('registeredDate') ? ' is-invalid' : '' }}" name="registeredDate" value="{{ old('registeredDate') }}" required autofocus>

                                @if ($errors->has('registeredDate'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('registeredDate') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
